        ...
        <div className="Content-image-container">
          <div>
            ...
            <div className="Content-Image-Edit-Button">
              <div className={!this.state.isImageEditable ? 'hidden' : ''} onClick={this.saveImage.bind(this)}>
          ...
          <div className="Content-image-container">
            ...
            <div className="Content-Image-Edit-Button">
              <div className={this.state.isImageEditable ? 'hidden' : ''} onClick={this.editImage.bind(this)}>
